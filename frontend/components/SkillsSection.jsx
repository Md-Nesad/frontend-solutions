      ...
      <div className=' mx-auto text-center'>
        ...
        <div className='inline-flex rounded-md  p-2 mb-12  gap-2'>
          <button
            ...
            className={`px-20 py-4 border border-gray-700 shadow-[0_0_5px_rgba(255,255,255,0.3)] rounded-md transition-all duration-300 text-lg ${
              activeTab === 'skills'
          ...
          <div className='grid md:grid-cols-2 gap-12 text-left'>
            ...
            <div>
              <h3 className='text-xl font-bold mb-10 relative'>
                Design Skill
                <span className='block w-28 h-0.5 bg-gradient-to-r from-purple-400 to-pink-500 mt-1' />
              </h3>
            ...
            <div>
              <h3 className='text-lg font-bold mb-10 relative'>
                Development Skill
                <span className='block w-40 h-0.5 bg-gradient-to-r from-purple-400 to-pink-500 mt-1' />
              </h3>
          ...
          <div className='grid md:grid-cols-2 gap-12 text-left'>
            ...
            <div>
              ...
              {experienceData.education.map((item, i) => (
                ...
                >
                  <h4 className='text-[#F5EDFF] text-xl font-semibold flex justify-between'>
                    {item.title}
                    <span className='text-[#FAAF40] text-sm font-medium'>
                      {item.gpa}
                    </span>
                  </h4>
