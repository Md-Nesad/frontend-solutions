...
export default function Testimonials() {
  ...
  return (
    ...
    >
      ...
      {/* Review Card */}
      <div className='relative bg-[#212428] mt-10 max-w-3xl h-60 w-full p-8 rounded-lg shadow-[0_0_10px_rgba(255,255,255,0.2)] text-center'>
        <span className='absolute top-3 left-4'>
          <TopIcon />
        </span>
        <p className='text-[#F5EDFFD9] text-lg italic leading-relaxed px-2 mt-13'>
          {review}
        </p>
